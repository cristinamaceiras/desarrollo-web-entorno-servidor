...
CREATE TABLE `tFavoritos` (
  ...
  CONSTRAINT `tFavoritos_ibfk_1` FOREIGN KEY (`idUsuario`) REFERENCES `tUsuarios` (`id`),
  CONSTRAINT `tFavoritos_ibfk_2` FOREIGN KEY (`idCancion`) REFERENCES `tCanciones` (`id`)
...
INSERT INTO `tFavoritos` VALUES (1,1,2),(2,1,5);
...
-- Dump completed on 2022-10-28 22:42:57
